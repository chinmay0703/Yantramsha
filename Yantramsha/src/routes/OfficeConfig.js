...
import pic from "../Images/98.webp";
import picc from "../Images/100.png";
import piccc from "../Images/101.webp";
...
function OfficeConfig() {
    ...
    const [option1Price, setoption1Price] = useState(3000);
    ...
    const handleDropdownChangee = (value,event) => {
        ...
        // Adjust option2Price based on the selected motherboard
        switch (value) {
    ...
    const handleDropdownChangeee = (value,event) => {
        ...
        // Adjust option3Price based on the selected memory option
        switch (value) {
                ...
                <div className='row'>
                    ...
                    <div className='col-6 overflow-autoo'>
                        ...
                        <div className="form-group row my-3">
                            ...
                            <div className='col-3'>
                                <h5 className='my-3 '>Motherboard</h5 >
                            </div>
                            <div className='row'>
                                <div className='col-11'>
                                    <div className="input-group">
                                        ...
                                        <div className="input-group-append">
                                            ...
                                            <div className="dropdown-menu custom-dropdown-menu">
                                                <a className="dropdown-item" href="#" onClick={() => handleDropdownChange('GeForce RTX 4070 12GB')}>GeForce RTX 4070 12GB</a>
                                                <a className="dropdown-item" href="#" onClick={() => handleDropdownChange('GeForce RTX 4070 Ti 12GB')}>GeForce RTX 4070 Ti 12GB</a>
                                                <a className="dropdown-item" href="#" onClick={() => handleDropdownChange('GeForce RTX 4070 Ti 16GB')}>GeForce RTX 4070 Ti 16GB</a>
                                                <a className="dropdown-item" href="#" onClick={() => handleDropdownChange('GeForce RTX 4070 Tm 32GB')}>GeForce RTX 4070 Tm 32GB</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
