...
import pic from "../Images/game.webp";
import picc from "../Images/game2.webp";
import piccc from "../Images/233.webp";
...
function GammingConfig() {
    ...
    const save = () => {
        ...
        localStorage.setItem("option1Price", option1Price);
        localStorage.setItem("option2", option2);
        localStorage.setItem("option2Price", option2Price);
        localStorage.setItem("option3", option3);
        localStorage.setItem("option3Price", option3Price);
                    ...
                    <div className='col-6 overflow-autoo'>
                        ...
                        <div className='container bg-white ' style={yy}>
                            <div className='row'>
                                ...
                                <div className='col-7'>
                                    <Link to={"/payment"}>
                                        <button className='btn btn-warning my-3 mx-4 ' style={jkjk} onClick={save}> Buy Now</button>
                                    </Link>
                                </div>
                            </div>
                        </div>
